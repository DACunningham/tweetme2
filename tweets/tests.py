...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        self.userb = User.objects.create_user(username="abc2", password="password")
        Tweet.objects.create(content="setup test content", user=self.user)
        Tweet.objects.create(content="setup test content", user=self.user)
        Tweet.objects.create(content="setup test content", user=self.userb)
    ...
    def test_tweet_created(self):
        tweet_obj = Tweet.objects.create(content="test content", user=self.user)
    ...
    def test_tweet_create_api_view(self):
        request_data = {"content": "test create tweet"}
        client = self.get_client()
